...
<br />
<h4>Items Edit Message</h4>
<?
	if ($error == 3 ) {
		echo "<h1>Item Edit Succeeded !!! </h1>";
	}
?>
<a href="./admin_items_list.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('back_button','','../images/buttons/back_hover.png',1)"><img src="../images/buttons/back.png" alt="Back" name="back_button" width="100" height="34" border="0" id="back_button" /></a>
