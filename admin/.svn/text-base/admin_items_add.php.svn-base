...
<head>
    ...
    <title>SimpleAuction - Items Add</title>
	...
	$(document).ready(function() {
		$('#items-add-form').validate({
				...
				messages: {
					...
					file: { 
                		required: "Please select an image for this item"
            		}
				},
		...
		$("#itemincrement").val("S$" + $("#slider-range").slider("value"));
...
<br />
<h1>Provide Items Info</h1>
<form id="items-add-form" method="post" class="common-form" action="admin_items_add_process.php" enctype="multipart/form-data">
	
    <table>
    	<tr>
    		<td class="label"><h4>Item Name</h4></td>
    		<td class="field"><input class="input" id="itemname" autofocus="autofocus" name="itemname" type="text" /></td>
        	<td class="status"></td>
    	</tr>
	...
	-moz-box-shadow: 0px 0px 5px 1px #dddddd; box-shadow: 0px 0px 5px 1px #dddddd;"></textarea></td>
            <td class="status"></td>
        </tr>
       <tr>
    		<td class="label"><h4>Item Start Date</h4></td>
    		<td class="field"><input class="input" id="itemstart" name="itemstart" type="text" /></td>
        	<td class="status"></td>
    	</tr> 
        <tr>
    		<td class="label"><h4>Item Close Date</h4></td>
    		<td class="field"><input class="input" id="itemclose" name="itemclose" type="text" /></td>
        	<td class="status"></td>
    	</tr> 	
        <tr>
    		<td class="label"><h4>Item Increment</h4></td>
    		<td class="field"><input class="input" id="itemincrement" name="itemincrement" type="text" readonly="readonly"/>
