...
<head>
    ...
    <title>SimpleAuction - Members Management</title>
...
<h1>Edit member by entering either their Username or User ID</h1>
</div>
</div>
...
<form id="admin-login-form" method="post" action="admin_ajax_members_process.php">
